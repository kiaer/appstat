...
<<barplotinit, echo=FALSE, fig.height=4, fig.pos="H", fig.cap="Initial Barplot of enzymes and concentration compared to response">>=
par(mfrow=c(1,1))
...
legend(16, 1000, col=c("snow1", "snow2", "snow3", "snow4"),legend =  c("Enzyme Concentration","0 nM", "2.5 nM", "7.5 nM", "15 nM"), lty = 1)
@

<<boxplotInit, echo=FALSE, fig.height=5, fig.pos="H">>=
