...
@
\section{Analysis}
<<boxcox, echo=FALSE, fig.height=5, out.width='.9\\linewidth', fig.cap="Boxcox Transformation of LM1">>=
...
\section{Results}
<<diagnostics, echo=FALSE, fig.cap="Diagnostics plot of LM4">>=
par(mfrow=c(2,2))
...
@
\newpage
<<enzymede, echo=FALSE, fig.height=6, out.width='.9\\linewidth'>>=
