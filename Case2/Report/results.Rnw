...
>>>>>>> 0c0332352591fcc851ddf55c958b0caf33e03350
...
@
From Figure \ref{fig:Prediction} we can confirm temperature has a larger impact on the and steeper increase than sun hours according to our model.
