...
xtable(summary(camptable), caption = "Summary of the climatic variables (columns 1-5), the total # of flocks (column 6), and the # of Campylobacter positive flocks (column 7) ", label = "tab:sum")
@
