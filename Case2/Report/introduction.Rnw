...
This report aims to investigate possible correlations between occurrences of Campylobacter and a series of climate variables. To initiate the analysis we will attempt to answer the following questions:

- What, if any, of the climate variables correlate to the occurrence of Campylobacter?

- Is there any there any significant trends in the data that are not explained by the cimate variables?
